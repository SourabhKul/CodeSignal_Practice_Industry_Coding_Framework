...
python3 -m unittest test_solution.TestChineseRestaurant.test_level_2_bulk_and_ranking
python3 -m unittest test_solution.TestChineseRestaurant.test_level_3_snapshots
python3 -m unittest test_solution.TestChineseRestaurant.test_level_4_forks
```
